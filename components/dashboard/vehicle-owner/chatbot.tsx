  ...
  const initializeChat = async () => {
    try {
      ...
      const welcomeMessage: Message = {
        id: '1',
        text: 'Hello! I\'m your intelligent vehicle assistant powered by advanced Gemini AI. I can help you with vehicle maintenance, troubleshooting, service schedules, warranty information, and much more. How can I assist you today?',
        sender: 'bot',
        timestamp: new Date(),
      };
